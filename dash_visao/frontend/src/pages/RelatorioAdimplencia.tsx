...
export default function RelatorioAdimplencia() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      await exportService.exportGenericExcel({
        ...
        columns: cols,
        title: `Relatorio de Adimplencia (${suffix}) - ${categoria} ${ano}`,
  ...
  return (
    <PageContainer>
      {/* Header */}
      <Box sx={{ mb: 4 }}>
        <Typography variant="h5">Relatorio de Adimplencia</Typography>
        <Typography variant="body2" color="text.secondary" sx={{ mt: 0.5 }}>
          Analise de adimplencia por CRO, categoria e ano.
        </Typography>
      </Box>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              <Typography variant="subtitle2" color="text.secondary">
                {isValores ? 'Adimplencia com Valores' : 'Adimplencia Quantitativo'} - {categoria} {ano}
              </Typography>
              <Chip
                ...
                <Table stickyHeader size="small">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell align="right">Nao Pago</TableCell>
                      {isValores && <TableCell align="right">Valor Devido (Nao Pago)</TableCell>}
