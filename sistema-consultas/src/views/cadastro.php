...
$labels = new Labels();
$buttons = $labels->getChildLabelsPorSigla("CD");
...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h5><i class="fas fa-plus-square mr-2 mt-2"></i>Sistema de Cadastros</h5>
        </div>
                    ...
                    <div class="col-md-6">
                        <?php foreach ($chunk as $label): ?>
                            <?php if ($label['disabled'] == 0): ?>
                                <?php if (Session::get('grupo') === 0 || $row['CD' . $label['referencial'] . 'acesso'] == true): ?>
                                    <a href="/cadastro?tipoConsulta=<?= $label['referencial'] ?>" class="btn-container">
                                        <button 
                                            type="button" 
