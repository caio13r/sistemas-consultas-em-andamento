...
if (Session::get('grupo') != 0 && $row['RE14acesso'] == false) {
...
<div class="container-fluid">
  ...
  <div class="card">
    ...
    <h5 class="card-title mb-4">Adimplência (com valores)</h5>
      
      <div class="col-md-6 offset-md-3">

        <div class="contact-form">
        <form class="book-form" method="POST" action="relatorio-adimplencia-valores-gerar">
            <div class="row">
                <div class="col-md-12">
                  <label for="origem">Selecione o tipo de relatório a emitir:</label>
                    <select class="form-control" id= "origem" name="origem" required>
                        ...
                        <option value="1">Relatório de Adimplência (com valores)</option>
                    </select>
                </div>
