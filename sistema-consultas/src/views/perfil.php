    ...
    <?php if (isset($inputGet['id']) && !isset($inputGet['edit'])) { ?>
      ...
      <div class="row">
        <div class="col-md-6">
                ...
                <b>Nome:</b><br>
                <?= htmlspecialchars($getUinfo->name); ?>
        </div>
        <div class="col-md-6">

        <b>E-mail:</b><br>
                <td width='70%'><p class="text-break"><?= htmlspecialchars($getUinfo->email); ?></p></td>
        ...
        <?php if (isset($getUinfo->telefoneCtt)) { ?>
          <div class="col-md-6">  
                ...
                <?= htmlspecialchars($getUinfo->telefoneCtt); ?>
          </div>
        <?php } ?>
        <?php if (isset($getUinfo->telefoneWpp)) { ?>
          <div class="col-md-6">
                <br><b>Telefone para Whatsapp:</b><br>
                <?= htmlspecialchars($getUinfo->telefoneWpp); ?>
          </div>
        <?php } ?>
      </div>
        ...
        <form action="#" method="POST">
          ...
          <div class="form-row">
            <div class="form-group col-md-9">
              ...
              <input type="text" id="name" name="name" value="<?= htmlspecialchars($getUinfo->name); ?>" class="form-control">
            </div>
          ...
          <div class="form-row">
            <div class="form-group col-12">
              ...
              <input type="email" id="email" name="email" value="<?= htmlspecialchars($getUinfo->email); ?>" class="form-control">
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" id="telefoneCtt" name="telefoneCtt" value="<?= htmlspecialchars($getUinfo->telefoneCtt); ?>" class="form-control" class="form-control" maxlength="14">
            </div>
            <div class="form-group col-md-6">
              <label for="telefoneWpp">Telefone para Whatsapp</label>
              <input type="text" id="telefoneWpp" name="telefoneWpp" value="<?= htmlspecialchars($getUinfo->telefoneWpp); ?>" class="form-control" class="form-control" maxlength="14">
            </div>
          </div>
          ...
          <div class="form-row mt-3 justify-content-center align-items-center" style="gap: 30px;">
            ...
            <div class="foto-container">
                ...
                <?php else: ?>
                    ...
                    <br>
                    <a style="margin-top: 5px" href="data:image/jpeg;base64,<?= $getUinfo->imagem ?>" download="foto_<?= htmlspecialchars($getUinfo->name) ?>.jpg" class="btn btn-primary">
                        Baixar Foto
                    </a>
                <?php endif; ?>
            </div>
