...
$tituloConsulta = "Auditoria - Total de Identidade Únicas emitidas"
?>

<div class="col-md-6 offset-md-3 mb-4">
<h6 class="mb-2">Total de Identidades Únicas já emitidas</h6>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select id="pfpj" name="pfpj" class="form-control">
                    <?php
                        $values = array('ALL' => 'Total de Identidades Únicas emitidas');
...
<?php 
    if (isset($inputPost["submit"])) { 
        ...
        try {
            ...
            $query = "SELECT CRO, CD, TSB, ASB, APD, TPD, TOTAL FROM CFO_CWS.dbo.vw_Cons_Identidades_Digitais_Unicas_Emitidas";
        ...
        $totalAll = array_sum(array_column($result, 'TOTAL'));
?>
