...
if (Session::get('grupo') != 0 && (!isset($row['CA12acesso']) || $row['CA12acesso'] == false)) {
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      if (Session::get('grupo') === 0 || (isset($row['CA12select']) && $row['CA12select'] == true)) {
...
<?php if (isset($inputPost["submit"])) {
    ...
    if (!empty($erro)) {
        ...
        try {
            ...
            error_log("Erro em auditoria 12: " . $error->getMessage());
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaAuditoria12" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
