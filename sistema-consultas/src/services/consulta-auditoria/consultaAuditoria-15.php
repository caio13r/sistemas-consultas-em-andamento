...
if (Session::get('grupo') != 0 && $row['CA15acesso'] == false) {
            ...
            <div class="form-group col-md-6">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      ...
                      if (Session::get('grupo') === 0 || $row['CA15select'] == true) {
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaConsultas15" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
...
$(document).ready(function() {
    $('#tabelaConsultas15').DataTable({
        "paging": true,
        "pageLength": 10,
        "lengthMenu": [10, 25, 50, 100],
        "order": [[4, "asc"]], // Ordena pela coluna CPF (index 4)
        "language": {
