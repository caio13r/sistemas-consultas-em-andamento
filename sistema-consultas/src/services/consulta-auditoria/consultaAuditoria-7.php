...
if (Session::get('grupo') != 0 && $row['CA7acesso'] == false) {
            ...
            <div class="form-group col-md-12">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      ...
                      if (Session::get('grupo') === 0 || $row['CA7select'] == true) {
...
<?php if (isset($inputPost["submit"])) { 
    ...
    try {
        ...
        $query = "SELECT * FROM CFO_CWS.dbo.Cons_Empresa_Ativa_Sem_RT WHERE $croQuery";
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaConsultas7" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
            ...
            <?php
                foreach ($result as $row) {
                    ...
                    echo "<td>" . $row['RT_Categoria'] . "</td>";
                    echo "<td>" . $row['RT_Inscricao'] . "</td>";
                    echo "<td>" . $row['RT_Nome'] . "</td>";
                    echo "<td>" . $row['RT_CPF'] . "</td>";
                    echo "<td>" . $row['RT_Situacao'] . "</td>";
                    echo "<td>" . $row['RT_Detalhe'] . "</td>";
                    echo "<td>" . $row['RT_Encerrado'] . "</td>";
                    echo "<td>" . $row['RT_Data_Encerramento'] . "</td>";
