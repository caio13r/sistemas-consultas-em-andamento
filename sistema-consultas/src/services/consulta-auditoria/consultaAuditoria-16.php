...
try {
    ...
    error_log("Erro em auditoria 16 (dropdown idade): " . $error->getMessage());
}
?>
    ...
    if (isset($inputPost["submit"])) {
        ...
        if (empty($erro)) {
            try {
                ...
                error_log("Erro em auditoria 16: " . $error->getMessage());
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaAuditoria16" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
