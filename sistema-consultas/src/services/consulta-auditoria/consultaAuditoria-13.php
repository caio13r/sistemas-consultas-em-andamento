...
if (Session::get('grupo') != 0 && (!isset($row['CA13acesso']) || $row['CA13acesso'] == false)) {
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      if (Session::get('grupo') === 0 || (isset($row['CA13select']) && $row['CA13select'] == true)) {
...
<?php if (isset($inputPost["submit"])) {
    ...
    if (!empty($erro)) {
        ...
        try {
            ...
            error_log("Erro em auditoria 13: " . $error->getMessage());
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaAuditoria13" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
            ...
            <?php foreach ($result as $linha) : ?>
                <tr>
                    ...
                    <td><?= htmlspecialchars($linha['Data Federal'] ?? '') ?></td>
