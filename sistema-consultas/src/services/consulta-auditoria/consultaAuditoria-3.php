...
if (Session::get('grupo') != 0 && (!isset($row['CA3acesso']) || $row['CA3acesso'] == false)) {
...
<div class="col-md-6 offset-md-3 mb-4">
    <h6 class="mb-2">Consultar total de cadastros provisórios vencidos</h6>
    <form action="" method="post">
        <div class="form-group">
            ...
            <select id="cro" name="cro" class="form-control" required>
                ...
                <?php
                if (Session::get('grupo') === 0 || (isset($row['CA3select']) && $row['CA3select'] == true)) {
    ...
    if (isset($erro)) {
        ...
        try {
            ...
            $query = "SELECT
                ...
                FROM CFO_CWS.dbo.vw_Rel_PreCadastrado_com_inscricao" . $whereClause;
            ...
            $queryError = true;
            error_log("Erro em auditoria 3: " . $error->getMessage());
...
?>
    ...
    <div class="row mt-4">
        <div class="col table-responsive">
            <table id="tabelaAuditoria3" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
                <thead>
                    <tr>
                        <th scope="col">CRO</th>
