...
if (Session::get('grupo') != 0 && isset($row['CA27acesso']) && $row['CA27acesso'] == false) {
...
$tituloConsulta = 'Auditoria - Profissionais em atividade do tipo temporário';
?>

<div class="col-md-6 offset-md-3 mb-4">
<h6 class="mb-2">Consultar profissionais em atividade do tipo temporário</h6>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                        if (Session::get('grupo') === 0 || (isset($row['CA27select']) && $row['CA27select'] == true)) {
    ...
    if (!empty($erro)) {
        ...
        try {
            ...
            $query = "SELECT
                        ...
                        Detalhe,
                        DataSituacao
                      FROM CFO_CWS.dbo.vw_Cons_Profissionais_Em_Atividade_Do_Tipo_Temporario
                      {$whereClause}";
            ...
            error_log("Erro em auditoria 27: " . $error->getMessage());
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaAuditoria27" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($linha['DataValidade'] ?? '') ?></td>
