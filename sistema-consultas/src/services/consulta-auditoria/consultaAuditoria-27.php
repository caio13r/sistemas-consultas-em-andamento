...
if (Session::get('grupo') != 0 && $row['CA27acesso'] == false) {
...
try {
    ...
    $queryCRO = "SELECT DISTINCT CRO FROM CFO_CWS.dbo.vw_Cons_Profissionais_Em_Atividade_Do_Tipo_Temporario ORDER BY CRO";
            ...
            <div class="form-group col-md-12">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      ...
                      if (Session::get('grupo') === 0 || $row['CA27select'] == true) {
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaConsultas27" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
