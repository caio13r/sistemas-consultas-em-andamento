...
if (Session::get('grupo') != 0 && isset($row['CA18acesso']) && $row['CA18acesso'] == false) {
    echo "<script>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      if (Session::get('grupo') === 0 || (isset($row['CA18select']) && $row['CA18select'] == true)) {
    ...
    if (isset($inputPost["submit"])) {
        ...
        if (empty($erro)) {
            try {
                ...
                $query = "SELECT * FROM CFO_CWS.dbo.vw_Cons_Caducados_Com_Registro_Em_Outro_Estado $whereClause";
                ...
                error_log("Erro em auditoria 18: " . $error->getMessage());
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaAuditoria18" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
