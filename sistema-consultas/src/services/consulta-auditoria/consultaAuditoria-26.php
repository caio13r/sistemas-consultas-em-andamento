...
if (Session::get('grupo') != 0 && $row['CA26acesso'] == false) {
            ...
            <div class="form-group col-md-12">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      ...
                      if (Session::get('grupo') === 0 || $row['CA26select'] == true) {
...
<div class="row mt-4">
    <div class="col table-responsive">
        <table id="tabelaConsultas26" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            <thead>
            <tr>
                <th scope="col">CRO</th>
