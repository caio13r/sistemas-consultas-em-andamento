...
$tituloConsulta = 'Estatísticas de Fiscalizações de Pessoas Sem Inscrições - Por Tipo pessoa e Período';
...
<?php if (isset($inputPost["submit"])) { 
    ...
    if ($inputPost['pessoa'] == 'ALL' || $inputPost['pessoa'] == '') {
        ...
        $pessoa = "AND CadPe.TipoPessoaFisica = $pessoa";
    }
    

    $path = realpath(dirname(__FILE__, 3)) . "/database/script/consultaFiscalizacao/consultaFiscalizacao12.sql";
