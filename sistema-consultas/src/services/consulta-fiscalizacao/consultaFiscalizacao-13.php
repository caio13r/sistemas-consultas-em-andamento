...
$tituloConsulta = 'Estatísticas de Fiscalizações por Fiscal - Por Categoria e Período';
...
<?php if (isset($inputPost["submit"])) { 
    ...
    if (!empty($erro)) {
        ...
        $path = realpath(dirname(__FILE__, 3)) . "/database/script/consultaFiscalizacao/consultaFiscalizacao13.sql";
