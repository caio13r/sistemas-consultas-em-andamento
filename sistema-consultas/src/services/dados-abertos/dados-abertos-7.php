...
if (Session::get('grupo') != 0 && $row['DA7acesso'] == false) {
...
$tituloConsulta = 'Dados Abertos - Contratos Cadastrados Aditivos';
?>
...
<div class="col-md-6 offset-md-3 mb-4">
    <label>Contratos Cadastrados Aditivos</label>
...
if (isset($_POST["submit"])) {
    try {
        ...
        $url = "https://cfo-br.implanta.net.br/portaltransparencia/servico/api/ContratosAditivos?vigenciaInicio="
            . urlencode($dtInicio)
            . "&vigenciaTermino="
            . urlencode($dtTermino)
        ;
...
<?php } else { ?>
    ...
    <div class="row mt-4">
        <div class="col">
            <!-- Tabela de Contratos Cadastrados Aditivos -->
            <h3>Contratos Cadastrados Aditivos</h3>
            <table id="tabelaDados" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
                <thead>
                    <tr>
                        ...
                        <th>Número Aditivo</th>
                        <th>Situação da Vigencia</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($result as $row) {
                        ...
                        echo "<td>" . $row['aditivos'] . "</td>";
                        echo "<td>" . $row['numero'] . "</td>";
                        echo "<td>" . $row['numeroProcesso'] . "</td>";
                        echo "<td>" . $row['numeroAditivo'] . "</td>";
                        echo "<td>" . $row['situacaoVigencia'] . "</td>";
                        echo "</tr>";
                    }
                    ?>
                </tbody>
