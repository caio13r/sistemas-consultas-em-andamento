...
if (Session::get('grupo') != 0 && $row['DA3acesso'] == false) {
...
$tituloConsulta = 'Dados Abertos - Balanço Financeiro';
?>
...
<div class="col-md-6 offset-md-3 mb-4">
    <label>Balanço Financeiro</label>
    <form action="" method="post">
        ...
        <button type="submit" name="submit" class="btn btn-primary">Consultar Balanço Financeiro</button>
    </form>
</div>
...
if (isset($_POST["submit"])) {
    try {
        ...
        $url = "https://cfo-br.implanta.net.br/portaltransparencia/servico/api/BalancoFinanceiro?referenciaInicio="
            . urlencode($dtInicio)
            . "&referenciaTermino="
            . urlencode($dtTermino)
        ;
            ...
            <table id="tabelaDados" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
                <thead>
                    <tr>
                        ...
                        <th>Nome Ingresso</th>
                        <th>Exercício Atual Ingresso</th>
                        <th>Exercício Anterior Ingresso</th>
                        <th>Códigos Dispendios</th>
                        <th>Nome Dispendios</th>
                        <th>Exercício Atual Dispendios</th>
                        <th>Exercício Anterior Dispendios</th>
                        <th>Sequencial</td>
                        <th>Link Notificação</td>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    foreach ($result as $row) {
                        echo "<tr>";
                        echo "<td>" . $row['codigoIngressos'] . "</td>";
                        echo "<td>" . $row['nomeIngressos'] . "</td>";
                        echo "<td>" . $row['exercicioAtualIngressos'] . "</td>";
                        echo "<td>" . $row['exercicioAnteriorIngressos'] . "</td>";
                        echo "<td>" . $row['codigoDispendios'] . "</td>";
                        echo "<td>" . $row['nomeDispendios'] . "</td>";
                        echo "<td>" . $row['exercicioAtualDispendios'] . "</td>";
                        echo "<td>" . $row['exercicioAnteriorDispendios'] . "</td>";
