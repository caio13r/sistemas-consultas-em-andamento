...
if (Session::get('grupo') != 0 && $row['DA10acesso'] == false) {
...
$tituloConsulta = 'Dados Abertos - Aquisições ou Alienações';
?>
...
<div class="col-md-6 offset-md-3 mb-4">
    <label>Aquisições ou Alienações</label>
    <form action="" method="post">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="mounth" id="numero_processo" name="numero_processo" class="form-control" placeholder="" required>
        </div>
        <div class="form-group col-md-6">
        ...
        <button type="submit" name="submit" class="btn btn-primary">Consultar Aquisições ou Alienações</button>
    </form>
</div>
...
if (isset($_POST["submit"])) {
    try {
        ...
        $url = "https://cfo-br.implanta.net.br/portaltransparencia/servico/api/RelacaoAquisicoes?referenciaInicio="
            . urlencode($dtInicio)
            . "&referenciaTermino="
            . urlencode($dtTermino)
            . "&numeroProcesso="
            . urlencode($numeroProcesso) 
            . "&numeroLicitacao=" 
...
<?php } else { ?>
    ...
    <div class="row mt-4">
        <div class="col">
            <!-- Tabela de Aquisições ou Alienações -->
            <h3>Aquisições ou Alienações</h3>
