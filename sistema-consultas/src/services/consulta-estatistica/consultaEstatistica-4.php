...
if (Session::get('grupo') != 0 && $row['CE4acesso'] == false) {
            ...
            <div class="form-group col-md-6">
                ...
                <select id="cro" name="cro" class="form-control">
                    ...
                    <?php
                      ...
                      if (Session::get('grupo') === 0 || $row['CE4select'] == true) {
...
<?php if (isset($inputPost["especialidade_cro"])) { 
    ...
    try {
        ...
        $query = "SELECT * FROM CFO_CWS.dbo.vw_Cons_Dados_Basicos_Especialidades_Sexo_Somados_CRO $croTable $especialidadeTable";
        $stmt = $con->prepare($query);
        // $stmt->bindValue(':cro', "{$inputPost["cro"]}", PDO::PARAM_STR);
        // $stmt->bindValue(':especialidade', "%{$inputPost["especialidade"]}%", PDO::PARAM_STR);
        $stmt->execute();
