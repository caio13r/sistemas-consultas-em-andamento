...
$tituloConsulta = 'Totalização de Ativos por Localidade';

?>

<div class="col-md-10 offset-md-1 mb-4">
<h6 class="mb-2">Totalização de Ativos por Localidade</h6>
    ...
    <div class="col table-responsive">
        <table id="consultaEstatistica10" class="table table-sm table-bordered table-striped table-hover mt-4 mb-4">
            ...
            <tr>
                <th scope="col">CRO</th>
                <th scope="col">UF</th>
                <th scope="col">LOCALIDADE (END. CORRESPONDENCIA)</th>
                <th scope="col">CD</th>
                <th scope="col">TPD</th>
                <th scope="col">TSB</th>
                <th scope="col">ASB</th>
