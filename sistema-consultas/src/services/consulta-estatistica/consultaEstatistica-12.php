...
$tituloConsulta = 'Totalização de Endereços Residenciais mais recentes de Ativos por Localidade';

?>

<div class="col-md-10 offset-md-1 mb-4">
<h6 class="mb-2">Totalização de Endereços Residenciais mais recentes de Ativos por Localidade</h6>
