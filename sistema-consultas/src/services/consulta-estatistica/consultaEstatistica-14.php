...
if (Session::get('grupo') != 0 && (isset($row['CE14acesso']) && $row['CE14acesso'] == false)) {
...
$tituloConsulta = 'Totalização de profissionais ativos por especialidade por sexo por ano';

?>

<div class="col-md-10 offset-md-1 mb-4">
<h6 class="mb-2">Totalização de profissionais ativos por especialidade por sexo por ano</h6>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <select id="ano" name="ano" class="form-control">
                    ...
                    try {
                        $query = "SELECT DISTINCT ANO FROM CFO_CWS.dbo.Cons_Registro_Especialidades_Por_Ano ORDER BY ANO DESC";
...
<?php if (isset($inputPost["submit"])) { 
    ...
    $path = realpath(dirname(__FILE__, 3)) . "/database/script/consultaEstatistica/consultaEstatistica14.sql";
