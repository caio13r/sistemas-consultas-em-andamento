...
if (Session::get('grupo') != 0 && (isset($row['CE18acesso']) && $row['CE18acesso'] == false)) {
...
$tituloConsulta = 'Totalização de profissionais ativos por habilitação por sexo por ano';

?>

<div class="col-md-10 offset-md-1 mb-4">
<h6 class="mb-2">Totalização de profissionais ativos por habilitação por sexo por ano</h6>
...
<?php if (isset($inputPost["submit"])) { 
    ...
    $path = realpath(dirname(__FILE__, 3)) . "/database/script/consultaEstatistica/consultaEstatistica18.sql";
