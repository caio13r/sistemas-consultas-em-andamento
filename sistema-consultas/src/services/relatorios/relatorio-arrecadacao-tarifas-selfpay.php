...
<div class="container-fluid">
    <h5 class="card-title mb-4">Relatório de Arrecadação e Tarifas do CARTÃO DE CRÉDITO - SELFPAY / BKBANK (busca pela data de crédito)</h5>
    <div class="col-md-6 offset-md-3">
        <div class="contact-form">
            <form class="book-form" method="POST" action="relatorio-arrecadacao-tarifas-selfpay-gerar" onsubmit="showLoading()">
                <div class="row">
                    <div class="col-md-6">
