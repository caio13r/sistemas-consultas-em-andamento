...
if (Session::get('grupo') != 0 && $row['RE12acesso'] == false) {
...
<div class="container-fluid">
    <h5 class="card-title mb-4">Relatório de Tarifas - Banco do Brasil</h5>
    <div class="col-md-6 offset-md-3">
        <div class="contact-form">
            <form class="book-form" method="POST" action="relatorio-tarifas-bb-gerar" onsubmit="showLoading()">
                <div class="row">
                    <div class="col-md-6">
