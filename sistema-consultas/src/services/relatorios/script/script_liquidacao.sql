--
--TOTALIZA AS TARIFAS DE LIQUIDA��O NO PERIODO DESEJADO PAGAS PELA DATA DE PAGAMENTO
--
...
SELECT 'AC' AS CRO,
	...
	COUNT(CASE WHEN PARI.OcorrenciaArquivoRetornoCodigo IS NOT NULL THEN 1 END) AS TotalLiquidacao,
	SUM (ISNULL(PARI.ValorTarifaBancaria, 0)) AS ValorLiquidacao
FROM Convenios AS C
	...
	LEFT JOIN cro_ac.Financeiro.ProcessamentoArquivosRetornosItens AS PARI 
		...
		AND PARI.OcorrenciaArquivoRetornoCodigo = 06 
