--
--TOTALIZA AS TARIFAS DE BAIXA NO PERIODO DESEJADO PAGAS PELA DATA DE PAGAMENTO
--

-- DECLARE
-- @dataInicio DATE = '2023-01-01',
-- @dataFim DATE = '2023-02-01',
-- @cro_uf AS VARCHAR = 'DF'
...
SELECT 'AC' AS CRO,
	...
	COUNT(CASE WHEN PARI.OcorrenciaArquivoRetornoCodigo IS NOT NULL THEN 1 END) AS TotalBaixa,
	SUM (ISNULL(PARI.ValorTarifaBancaria, 0)) AS ValorBaixa
FROM Convenios AS C
	...
	LEFT JOIN cro_ac.Financeiro.ProcessamentoArquivosRetornosItens AS PARI 
		...
		AND PARI.OcorrenciaArquivoRetornoCodigo = 09 
